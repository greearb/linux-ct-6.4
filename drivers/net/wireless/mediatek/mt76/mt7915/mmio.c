...
static const u32 mt7915_offs[] = {
	...
	[LPON_UTTR1]		= 0x084,
	[LPON_FRCR]		= 0x314,
	[MIB_SDR0]		= 0x010, /* NOTE:  Does not match pattern, verify */
	[MIB_SDR3]		= 0x014,
	[MIB_SDR4]		= 0x018,
	[MIB_SDR5]		= 0x01c,
	[MIB_SDR6]		= 0x020,
...
static const u32 mt7916_offs[] = {
	...
	[LPON_UTTR1]		= 0x364,
	[LPON_FRCR]		= 0x37c,
	[MIB_SDR0]		= 0x0, /* How to get this on 7916? */
	[MIB_SDR3]		= 0x698,
	[MIB_SDR4]		= 0x788,
	[MIB_SDR5]		= 0x780,
	[MIB_SDR6]		= 0x0, /* How to get this on 7916? */
	[MIB_SDR7]		= 0x5a8,
	[MIB_SDR8]		= 0x78c,
	[MIB_SDR9]		= 0x024,
	[MIB_SDR10]		= 0x76c,
	...
	[MIB_SDR31]		= 0x55c,
	[MIB_SDR32]		= 0x7a8,
	[MIB_SDR38]		= 0x0, /* How to get this on 7916? */
	[MIB_SDR39]		= 0x0, /* How to get this on 7916? */
	[MIB_SDR40]		= 0x0, /* How to get this on 7916? */
	[MIB_SDR42]		= 0x0, /* How to get this on 7916? */
	[MIB_SDR43]		= 0x0, /* How to get this on 7916? */
	[MIB_SDR46]		= 0x0, /* How to get this on 7916? */
	[MIB_SDR50]		= 0x0, /* How to get this on 7916? */
	[MIB_SDR51]		= 0x0, /* How to get this on 7916? */
	[MIB_SDRMUBF]		= 0x7ac,
	[MIB_DR8]		= 0x56c,
	[MIB_DR9]		= 0x570,
	[MIB_DR11]		= 0x574,
	...
	[AC_OFFSET]		= 0x080,
	[ETBF_PAR_RPT0]		= 0x100,
	[M0DROPSR00]		= 0x0, /* How to get this on 7916? */
	[M0DROPSR01]            = 0x0, /* How to get this on 7916? */
};
